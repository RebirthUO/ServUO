...
{
	public class NoahTheTailor : BaseCraftChampion
	{
		[Constructable]
		public NoahTheTailor() : base(AIType.AI_Melee)
		{
			Body = 172;
			Name = "Rikktor";
		...
		public NoahTheTailor(Serial serial)
			: base(serial)
		{
		}

		public override CraftChampionSkullType SkullType => CraftChampionSkullType.Tailor;
		public override Type[] UniqueList => new[] { typeof(CrownOfTalKeesh) };

		public override Type[] SharedList => new[]
		{
			typeof(TheMostKnowledgePerson), typeof(BraveKnightOfTheBritannia),
			typeof(LieutenantOfTheBritannianRoyalGuard)
		};

		public override Type[] DecorativeList => new[]
		{
			typeof(LavaTile), typeof(MonsterStatuette), typeof(MonsterStatuette)
		};

		public override MonsterStatuetteType[] StatueTypes => new[]
		{
			MonsterStatuetteType.OphidianArchMage, MonsterStatuetteType.OphidianWarrior
		};
		...
		public override void OnChampPopped(SuperChampionSpawn<CraftChampionSpawnType> spawn)
		{

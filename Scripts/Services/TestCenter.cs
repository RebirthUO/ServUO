...
namespace Server.Misc
{
	...
	{
		[ConfigProperty("Server.TestCenter")]
		public static bool Enabled { get => Config.Get("Server.TestCenter", false); set => Config.Set("Server.TestCenter", value); }
		...
		private static void ChangeSkill(Mobile from, string name, double value)
		{
			...
			if (!Enum.TryParse(name, true, out SkillName index))
			{
